...
Original file is located at
    https://colab.research.google.com/drive/1WKnFkHT1FjO8SXK5J5c5o6zj4JzVj16u
...
"""
# Word2Vec
[tutorial](https://www.tensorflow.org/tutorials/text/word2vec)
  implements Skip-gram Model
  trains your own Word2Vec model on a small dataset
  
  is not an exact implementation of the papers.
  is intended to illustrate the key ideas.
  is based on:
    * [Efficient Estimation of Word Representations in Vector Space](https://arxiv.org/pdf/1301.3781.pdf)
    * [Distributed Representations of Words and Phrases and their Compositionality](https://papers.nips.cc/paper/5021-distributed-representations-of-words-and-phrases-and-their-compositionality.pdf).
     
Continuous Bag-of-Words Model
  predicts a word given the neighboring context.
...
A skip-gram model
  predicts the context/neighbors of a word given the word itself, which are 
