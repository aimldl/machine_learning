...
#   Module imports for the (old version of) Keras
...
#    Module imports for Keras in TensorFlow2
#      https://www.tensorflow.org/api_docs/python/tf/keras/datasets/reuters/load_data#returns
